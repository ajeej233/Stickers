 ...
 * @since 2/14/2018
 */
public class ImageFilterView @JvmOverloads constructor(
    context: Context,
    ...
    public suspend fun saveBitmap(): Bitmap = mutex.withLock {
        suspendCoroutine { continuation ->
            bitmapReadyContinuation = continuation
            requestRender()
        }
    }
    suspend fun saveBitmap1(callback: BitmapCallback1) {
        mutex.withLock {
            try {
