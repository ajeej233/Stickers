...
internal class MultiTouchListener(
    ...
    viewState: PhotoEditorViewState) : OnTouchListener {
...
//                    view.animate().translationY(0f).translationY(0f)
    ...
    private inner class GestureListener : SimpleOnGestureListener() {
        ...
        override fun onLongPress(e: MotionEvent) {
            super.onLongPress(e)
             mOnPhotoEditorListener?.onViewClicked(view2!!)
            val view1: TextView = view2!!.findViewById<TextView>(R.id.tvPhotoEditorText)
            Log.e("TextSize","mOnPhotoEditorListener    "+view1.textSize);
