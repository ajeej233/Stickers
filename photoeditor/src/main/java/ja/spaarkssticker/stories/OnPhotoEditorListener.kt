...
interface OnPhotoEditorListener {
    ...
    fun onEditTextChangeListener(rootView: View, text: String, colorCode: Int,background : Drawable,textSize : Float)
    fun onEditTextChangeListener(rootView: View, text: String, colorCode: Int,background : Drawable,textSize : Float,textValue : Int)
