...
import ja.spaarkssticker.stories.MultiTouchListener.OnGestureControl
    ...
    protected fun buildGestureController(
        ...
        return object : OnGestureControl {
            ...
            override fun onLongClick() {
                ...
                val view1: TextView = rootView.findViewById<TextView>(R.id.tvPhotoEditorText)
                Log.e("TextSize","onLongClick"+view1.textSize);
                updateView(rootView)
            }
        }
    }
